package com.tiviacz.travelersbackpackneo.client.model;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import com.tiviacz.travelersbackpackneo.TravelersBackpack;
import com.tiviacz.travelersbackpack.blockentity.BackpackBlockEntity;
import com.tiviacz.travelersbackpackneo.client.renderer.BackpackRenderInfo;
...
public class BackpackBlockModel {
    ...
    public void render(BackpackBlockEntity blockEntity, PoseStack poseStack, MultiBufferSource buffer, int combinedLightIn, int combinedOverlayIn) {
        ...
        if(item == ModItemsNeo.STANDARD_TRAVELERS_BACKPACK.get() && wrapper.getBackpackStack().has(DataComponents.DYED_COLOR)) {
        ...
        if(item == ModItemsNeo.QUARTZ_TRAVELERS_BACKPACK.get() || item == ModItemsNeo.SNOW_TRAVELERS_BACKPACK.get()) { //Do the same for Slime and Snow (Icey) Backpack
    ...
    public void renderByItem(ItemStack backpack, PoseStack poseStack, MultiBufferSource buffer, int combinedLightIn, int combinedOverlayIn) {
        ...
        ResourceLocation loc = item.getBackpackTexture();
        VertexConsumer vertexConsumer = buffer.getBuffer(RenderType.entityTranslucent(loc));
        boolean renderDefault = !backpack.has(ModDataComponents.RENDER_INFO);
        ...
        if(renderDefault) {
            ...
            BackpackRenderInfo renderInfo = new BackpackRenderInfo(backpack, backpack.get(ModDataComponents.RENDER_INFO));
