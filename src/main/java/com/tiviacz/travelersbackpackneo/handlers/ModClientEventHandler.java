...
import com.tiviacz.travelersbackpackneo.client.renderer.BackpackBlockEntityRenderer;
import com.tiviacz.travelersbackpackneo.client.renderer.BackpackEntityLayer;
import com.tiviacz.travelersbackpackneo.client.renderer.BackpackItemStackRenderer;
...
import com.tiviacz.travelersbackpackneo.client.screens.HudOverlay;
import com.tiviacz.travelersbackpackneo.client.screens.tooltip.BackpackTooltipComponent;
import com.tiviacz.travelersbackpackneo.client.screens.tooltip.ClientBackpackTooltipComponent;
...
public class ModClientEventHandler {
    ...
    public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
        event.registerEntityRenderer(ModItemsNeo.BACKPACK_ITEM_ENTITY.get(), ItemEntityRenderer::new);
    }
    ...
    public static void registerItemModelProperties() {
        ItemProperties.register(ModItemsNeo.HOSE.get(), ResourceLocation.fromNamespaceAndPath(TravelersBackpack.MODID, "mode"), (stack, world, entity, propertyFunction) -> {
