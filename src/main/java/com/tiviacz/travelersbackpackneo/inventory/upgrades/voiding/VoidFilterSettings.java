package com.tiviacz.travelersbackpackneo.inventory.upgrades.voiding;
...
public class VoidFilterSettings {
    ...
    public void updateFilter(List<ItemStack> items) {
        this.filterItems = items.stream().limit(TravelersBackpackConfig.SERVER.backpackUpgrades.voidUpgradeSettings.filterSlotCount.get()).filter(stack -> !stack.isEmpty()).toList();
    }
