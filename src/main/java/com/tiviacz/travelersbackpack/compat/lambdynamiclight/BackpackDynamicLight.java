...
public class BackpackDynamicLight implements DynamicLightsInitializer {
    public static final EntityLuminance.Type TYPE = EntityLuminance.Type.registerSimple(new ResourceLocation(TravelersBackpack.MODID, "lantern_upgrade"), BackpackEntityLuminance.INSTANCE);
