...
public class BlockEntityTransferInfo implements IRecipeTransferInfo<TravelersBackpackBlockEntityScreenHandler, RecipeEntry<CraftingRecipe>>
{
    @Override
    ...
    @Override
    public boolean canHandle(TravelersBackpackBlockEntityScreenHandler container, RecipeEntry<CraftingRecipe> recipe)
    {
        return container.inventory.getSettingsManager().hasCraftingGrid();
    }

    @Override
    public List<Slot> getRecipeSlots(TravelersBackpackBlockEntityScreenHandler container, RecipeEntry<CraftingRecipe> recipe)
    {
    ...
    @Override
    public List<Slot> getInventorySlots(TravelersBackpackBlockEntityScreenHandler container, RecipeEntry<CraftingRecipe> recipe)
    {
        List<Slot> list = new ArrayList<>();
