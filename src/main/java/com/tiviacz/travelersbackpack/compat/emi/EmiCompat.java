...
public class EmiCompat implements EmiPlugin
{
    ...
    private static class GridMenuInfo<T extends TravelersBackpackBaseMenu> implements StandardRecipeHandler<T>
    {
        ...
        public boolean craft(EmiRecipe recipe, EmiCraftContext<T> context)
        {
            ...
            PacketDistributor.SERVER.noArg().send(new ServerboundSettingsPacket(context.getScreenHandler().container.getScreenID(), SettingsManager.CRAFTING, SettingsManager.SHOW_CRAFTING_GRID, (byte)1));
