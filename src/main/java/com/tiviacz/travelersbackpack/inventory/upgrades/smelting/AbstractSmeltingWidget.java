    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        if(isTabOpened() && screen.getWrapper().getScreenID() == Reference.WEARABLE_SCREEN_ID) {
            ...
            if(upgrade.isBurning()) {
                ...
                guiGraphics.blit(RenderType::guiTextured, BackpackScreen.TABS, pos.x() + 7, pos.y() + 55 - k, 0, 213 - k, 14, k + 1, 256, 256);
            }
            ...
            if(upgrade.isCooking()) {
                ...
                guiGraphics.blit(RenderType::guiTextured, BackpackScreen.TABS, pos.x() + 28, pos.y() + 42, 14, 200, l, 13, 256, 256);
            }
        }
    }
