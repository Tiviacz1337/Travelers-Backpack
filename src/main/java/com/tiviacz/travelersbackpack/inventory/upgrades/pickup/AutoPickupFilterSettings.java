...
public class AutoPickupFilterSettings extends FilterSettingsBase<AutoPickupUpgrade> {
    ...
    public AutoPickupFilterSettings(ItemStackHandler storage, List<ItemStack> items, List<Integer> filterSettings, HolderLookup.Provider access) {
        super(storage, items, filterSettings, access, TravelersBackpackConfig.SERVER.backpackUpgrades.pickupUpgradeSettings.filterSlotCount.get());
    }
