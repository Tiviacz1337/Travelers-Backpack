	...
	public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer player, boolean willHarvest)
    {
		...
		if(state.getBlock() == ModBlocks.SLEEPING_BAG_BOTTOM)
		{
			if(!world.isRemote)
			{
				...
				if(world.getTileEntity(mayTilePos) instanceof TileEntityTravelersBackpack)
				{
					TileEntityTravelersBackpack tile = (TileEntityTravelersBackpack)world.getTileEntity(mayTilePos);
