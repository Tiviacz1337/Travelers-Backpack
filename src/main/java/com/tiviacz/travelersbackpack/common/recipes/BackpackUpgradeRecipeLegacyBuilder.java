...
public class BackpackUpgradeRecipeLegacyBuilder {
    ...
    public BackpackUpgradeRecipeLegacyBuilder(RecipeSerializer<?> p_266753_, Ingredient p_267080_, Ingredient p_267246_, RecipeCategory p_267024_, Item p_266767_) {
    ...
    public static BackpackUpgradeRecipeLegacyBuilder m_266485_(Ingredient p_266949_, Ingredient p_267302_, RecipeCategory p_266837_, Item p_266863_) {
        return new BackpackUpgradeRecipeLegacyBuilder(ModRecipeSerializers.BACKPACK_UPGRADE_LEGACY.get(), p_266949_, p_267302_, p_266837_, p_266863_);
    }

    public BackpackUpgradeRecipeLegacyBuilder m_266457_(String p_267310_, CriterionTriggerInstance p_266808_) {
    ...
    public void m_266417_(Consumer<FinishedRecipe> p_266852_, ResourceLocation p_267253_) {
        ...
        p_266852_.accept(new BackpackUpgradeRecipeLegacyBuilder.Result(p_267253_, this.f_265951_, this.f_266058_, this.f_265936_, this.f_265902_, this.f_266025_, p_267253_.withPrefix("recipes/" + this.f_266038_.getFolderName() + "/")));
    }
