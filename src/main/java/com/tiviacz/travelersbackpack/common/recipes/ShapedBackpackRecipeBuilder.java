...
public class ShapedBackpackRecipeBuilder implements RecipeBuilder
{
    ...
    public ShapedBackpackRecipeBuilder(ItemLike pResult, int pCount) {
     ...
     */
    public static ShapedBackpackRecipeBuilder shaped(ItemLike pResult) {
     ...
     * Creates a new builder for a shaped recipe.
     */
    public static ShapedBackpackRecipeBuilder shaped(ItemLike pResult, int pCount) {
        return new ShapedBackpackRecipeBuilder(pResult, pCount);
    }
    ...
    public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        pFinishedRecipeConsumer.accept(new ShapedBackpackRecipeBuilder.Result(pRecipeId, this.result, this.count, this.group == null ? "" : this.group, this.rows, this.key, this.advancement, new ResourceLocation(pRecipeId.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + pRecipeId.getPath())));
    }
    ...
    public static class Result implements FinishedRecipe {
        ...
        {
            return ModRecipeSerializers.BACKPACK_SHAPED.get();
        }
