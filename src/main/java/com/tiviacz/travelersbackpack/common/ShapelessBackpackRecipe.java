...
public class ShapelessBackpackRecipe extends ShapelessOreRecipe 
{
	...
	private ItemStack damageShears(final ItemStack stack)
	{
		...
		if(stack.attemptDamageItem(1, craftingPlayer == null ? new Random() : craftingPlayer.world.rand, craftingPlayer instanceof EntityPlayerMP ? (EntityPlayerMP) craftingPlayer : null))
		{
