...
public class TravelersBackpackCreativeTab extends CreativeTabs
{
	public TravelersBackpackCreativeTab(String label)
	{
		super(label);
	}
	...
	{
		return new ItemStack(ModItems.TRAVELERS_BACKPACK);
	}
	...
	{
		list.add(new ItemStack(ModItems.TRAVELERS_BACKPACK, 1, meta));
	}
}