...
public class ServerActions
{
    public static void swapTool(PlayerEntity player, double scrollDelta)
    {
        if(ComponentUtils.isWearingBackpack(player))
        {
            ...
            if(!inv.getStack(inventory.getTier().getSlotIndex(Tiers.SlotType.TOOL_UPPER)).isEmpty() && inv.getStack(inventory.getTier().getSlotIndex(Tiers.SlotType.TOOL_LOWER)).isEmpty() || !inv.getStack(inventory.getTier().getSlotIndex(Tiers.SlotType.TOOL_LOWER)).isEmpty() && inv.getStack(inventory.getTier().getSlotIndex(Tiers.SlotType.TOOL_UPPER)).isEmpty())
            {
