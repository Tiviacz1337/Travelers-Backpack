...
public class BackpackRenderInfo {
    ...
    public boolean isDyed() {
        return this.backpack.has(DataComponents.DYED_COLOR) && this.backpack.getItem() == ModItems.STANDARD_TRAVELERS_BACKPACK;
    }

    public int getSleepingBagColor() {
        return this.backpack.getOrDefault(ModDataComponents.SLEEPING_BAG_COLOR, DyeColor.RED.getId());
    }
