...
public class HudOverlay {
    ...
    public static void renderOverlay(GuiGraphics guiGraphics, float partialTicks) {
        if(TravelersBackpackConfig.getConfig().client.overlay.enableOverlay && !Minecraft.getInstance().options.hideGui && ComponentUtils.isWearingBackpack(Minecraft.getInstance().player) && Minecraft.getInstance().gameMode.getPlayerMode() != GameType.SPECTATOR) {
