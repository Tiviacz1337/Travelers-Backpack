...
public class UpgradeSlot {
    ...
    public void render(GuiGraphics guiGraphics, int xPos, int yPos) {
        ...
        if(NbtHelper.getOrDefault(this.upgradesHandler.getStackInSlot(this.index), ModDataHelper.TAB_OPEN, false)) { //this.upgradesHandler.getStackInSlot(this.index).getOrDefault(ModDataComponents.TAB_OPEN.get(), false)) {
            return;
        }
