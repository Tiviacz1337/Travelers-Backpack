...
public class BackpackUnbakedModel implements UnbakedModel {
    private static final ResourceLocation DYED_BACKPACK = ResourceLocation.fromNamespaceAndPath(TravelersBackpack.MODID, "block/backpack_dyed");
    ...
    public BakedModel bake(ModelBaker baker, Function<Material, TextureAtlasSprite> spriteGetter, ModelState state) {
        BakedModel original = this.unbaked.bake(baker, spriteGetter, state);
