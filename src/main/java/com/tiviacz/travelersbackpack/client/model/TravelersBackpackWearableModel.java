...
public class TravelersBackpackWearableModel<T extends LivingEntity> extends BipedModel<T>
{
    ...
    public TravelersBackpackWearableModel(LivingEntity livingEntity, IRenderTypeBuffer buffer)
    {
        super(0.0F);
        ...
        {
            this.stacks = new StackRenderer(this, (PlayerEntity)this.livingEntity, buffer);
            this.fluids = new FluidRenderer(this, (PlayerEntity)this.livingEntity, buffer);
        }
    }
    ...
    public void renderToBuffer(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha)
    {
        if(alpha == 0.25F)
        {
            this.bed.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, 1.0F);
        }
        else
        {
            this.bed.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
            this.bedExtras.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
            ...
            {
                ItemStack stack = this.livingEntity instanceof PlayerEntity ? CapabilityUtils.getWearingBackpack((PlayerEntity)this.livingEntity) : CapabilityUtils.getWearingBackpack(this.livingEntity);
    ...
    public void setupAngles(BipedModel<T> model)
    {
        ...
        this.bedExtras.copyFrom(model.body);
