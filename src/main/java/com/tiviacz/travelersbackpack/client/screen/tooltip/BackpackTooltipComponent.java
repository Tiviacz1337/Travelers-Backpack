...
public class BackpackTooltipComponent implements TooltipComponent
{
    ...
    public void drawItems(TextRenderer textRenderer, int x, int y, MatrixStack matrices, ItemRenderer itemRenderer, int z, TextureManager textureManager)
    {
        ...
        if(BackpackUtils.isCtrlPressed())
        {
            ...
            {
                this.renderItemInSlot(x + 42 - 18, y + (component.tier.getOrdinal() * 18) + 18 + 6, slot, textRenderer, matrices, itemRenderer, z, textureManager, false);
                slot++;
            }

            if(component.hasToolInSlot(Tiers.SlotType.TOOL_UPPER))
            {
                this.renderItemInSlot(x + 42 - 18, y + (component.tier.getOrdinal() * 18) + 36 + 6, slot, textRenderer, matrices, itemRenderer, z, textureManager, false);
                slot++;
            }
    ...
    private void renderItemInSlot(int x, int y, int slot, TextRenderer textRenderer, MatrixStack matrices, ItemRenderer itemRenderer, int z, TextureManager textureManager, boolean isCrafting)
    {
    ...
    private void blit(MatrixStack matrices, int x, int y, int z, TextureManager textureManager)
    {
