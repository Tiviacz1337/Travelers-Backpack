...
public class LootItemHasColorCondition implements LootCondition
{
    ...
    {
        return lootContext.get(LootContextParameters.BLOCK_ENTITY) instanceof TravelersBackpackBlockEntity && ((TravelersBackpackBlockEntity)lootContext.get(LootContextParameters.BLOCK_ENTITY)).hasColor();
    }
