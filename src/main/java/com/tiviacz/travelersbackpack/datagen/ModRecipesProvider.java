...
public class ModRecipesProvider extends FabricRecipeProvider
{
    ...
    {
        ShapelessRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, output).input(ModItems.WHITE_SLEEPING_BAG).input(input).group("dyed_sleeping_bag").criterion("has_sleeping_bag", RecipeProvider.conditionsFromItem(ModItems.WHITE_SLEEPING_BAG)).offerTo(exporter, RecipeProvider.convertBetween(output, ModItems.WHITE_SLEEPING_BAG));
    }
