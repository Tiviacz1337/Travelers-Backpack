...
public class ModRecipeProvider extends RecipeProvider
{
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> writer)
    {
        ...
        {
            BackpackUpgradeRecipeBuilder.smithing(Ingredient.of(Items.LEATHER), Ingredient.of(item), Ingredient.of(ModTags.BACKPACK_UPGRADES), RecipeCategory.MISC, item).unlocks(getHasName(item), has(item)).save(writer, id(getItemName(item) + "_smithing"));
        }
        ...
        List<Item> list = List.of(Items.BLACK_DYE, Items.BLUE_DYE, Items.BROWN_DYE, Items.CYAN_DYE, Items.GRAY_DYE, Items.GREEN_DYE, Items.LIGHT_BLUE_DYE, Items.LIGHT_GRAY_DYE,
                Items.LIME_DYE, Items.MAGENTA_DYE, Items.ORANGE_DYE, Items.PINK_DYE, Items.PURPLE_DYE, Items.RED_DYE, Items.YELLOW_DYE, Items.WHITE_DYE);
        List<Item> list2 = List.of(ModItems.BLACK_SLEEPING_BAG.get(), ModItems.BLUE_SLEEPING_BAG.get(), ModItems.BROWN_SLEEPING_BAG.get(), ModItems.CYAN_SLEEPING_BAG.get(),
                ...
                ModItems.LIME_SLEEPING_BAG.get(), ModItems.MAGENTA_SLEEPING_BAG.get(), ModItems.ORANGE_SLEEPING_BAG.get(), ModItems.PINK_SLEEPING_BAG.get(),
                ModItems.PURPLE_SLEEPING_BAG.get(), ModItems.RED_SLEEPING_BAG.get(), ModItems.YELLOW_SLEEPING_BAG.get(), ModItems.WHITE_SLEEPING_BAG.get());
    ...
    protected static void sleepingBagFromWool(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ItemLike sleepingBag, ItemLike pWool) {
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, sleepingBag).group("sleeping_bag").define('#', pWool).define('X', Items.WHITE_WOOL).pattern("##X").unlockedBy(getHasName(pWool), has(pWool)).save(pFinishedRecipeConsumer);
    }
    ...
    protected static void colorBlockWithDye(Consumer<FinishedRecipe> pFinishedRecipeConsumer, List<Item> pDyes, List<Item> pDyeableItems, String pGroup) {
        for (int i = 0; i < pDyes.size(); ++i) {
            ...
            ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, item1)
                    ...
                    .save(pFinishedRecipeConsumer, id("dye_" + getItemName(item1)));
        }
    }
