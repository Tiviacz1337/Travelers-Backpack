...
public class ModRecipeProvider extends RecipeProvider
{
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> writer)
    {
        ...
        {
            BackpackUpgradeRecipeBuilder.m_266485_(Ingredient.of(createTieredStack(item, Tiers.LEATHER)), Ingredient.of(ModItems.IRON_TIER_UPGRADE.get()), RecipeCategory.TOOLS, item).m_266457_("has_iron_tier_upgrade", RecipeProvider.has(ModItems.IRON_TIER_UPGRADE.get())).m_266193_(writer, getItemName(item) + "_smithing_iron");
            BackpackUpgradeRecipeBuilder.m_266485_(Ingredient.of(createTieredStack(item, Tiers.IRON)), Ingredient.of(ModItems.GOLD_TIER_UPGRADE.get()), RecipeCategory.TOOLS, item).m_266457_("has_gold_tier_upgrade", RecipeProvider.has(ModItems.GOLD_TIER_UPGRADE.get())).m_266193_(writer, getItemName(item) + "_smithing_gold");
            BackpackUpgradeRecipeBuilder.m_266485_(Ingredient.of(createTieredStack(item, Tiers.GOLD)), Ingredient.of(ModItems.DIAMOND_TIER_UPGRADE.get()), RecipeCategory.TOOLS, item).m_266457_("has_diamond_tier_upgrade", RecipeProvider.has(ModItems.DIAMOND_TIER_UPGRADE.get())).m_266193_(writer, getItemName(item) + "_smithing_diamond");
            BackpackUpgradeRecipeBuilder.m_266485_(Ingredient.of(createTieredStack(item, Tiers.DIAMOND)), Ingredient.of(ModItems.NETHERITE_TIER_UPGRADE.get()), RecipeCategory.TOOLS, item).m_266457_("has_netherite_tier_upgrade", RecipeProvider.has(ModItems.NETHERITE_TIER_UPGRADE.get())).m_266193_(writer, getItemName(item) + "_smithing_netherite");
        }
    }
