...
public class ModRecipeProvider extends RecipeProvider
{
    ...
    {
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, pDyedBed).requires(ModItems.WHITE_SLEEPING_BAG.get()).requires(pDye).group("dyed_sleeping_bag").unlockedBy("has_sleeping_bag", has(ModItems.WHITE_SLEEPING_BAG.get())).save(pFinishedRecipeConsumer, getConversionRecipeName(pDyedBed, ModItems.WHITE_SLEEPING_BAG.get()));
    }
