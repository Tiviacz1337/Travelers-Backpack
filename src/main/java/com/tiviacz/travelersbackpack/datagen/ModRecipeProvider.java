        ...
        return new RecipeProvider(registries, writer) {
            ...
            public void buildRecipes() {
                ...
                for(Item item : BACKPACKS) {
                    BackpackUpgradeRecipeBuilder.backpackUpgrade(ofTag(ConventionalItemTags.LEATHERS), Ingredient.of(item), ofTag(ModTags.BACKPACK_UPGRADES), RecipeCategory.MISC, item).unlocks(getHasName(item), has(item)).save(writer, getItemName(item) + "_smithing");
                }

                //Upgrades
                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.BLANK_UPGRADE, 4)
                ...
                createFullGrid(ModItems.IRON_TIER_UPGRADE, Ingredient.of(ModItems.BLANK_UPGRADE),
                        ofTag(ConventionalItemTags.IRON_INGOTS), Items.IRON_INGOT, ConventionalItemTags.IRON_INGOTS).save(writer);
                createFullGrid(ModItems.GOLD_TIER_UPGRADE, Ingredient.of(ModItems.BLANK_UPGRADE),
                        ofTag(ConventionalItemTags.GOLD_INGOTS), Items.GOLD_INGOT, ConventionalItemTags.GOLD_INGOTS).save(writer);
                createFullGrid(ModItems.DIAMOND_TIER_UPGRADE, Ingredient.of(ModItems.BLANK_UPGRADE),
                        ofTag(ConventionalItemTags.DIAMOND_GEMS), Items.DIAMOND, ConventionalItemTags.DIAMOND_GEMS).save(writer);
                ...
                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.TANKS_UPGRADE).define('A', ModItems.BACKPACK_TANK)
                        ...
                        .unlockedBy(getHasName(ModItems.BLANK_UPGRADE), has(ModItems.BLANK_UPGRADE)).save(writer);

                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.CRAFTING_UPGRADE).define('A', ConventionalItemTags.PLAYER_WORKSTATIONS_CRAFTING_TABLES)
                        .define('B', ModItems.BLANK_UPGRADE).define('C', ConventionalItemTags.WOODEN_CHESTS).pattern("A").pattern("B").pattern("C")
                        .unlockedBy(getHasName(ModItems.BLANK_UPGRADE), has(ModItems.BLANK_UPGRADE)).save(writer);

                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.FEEDING_UPGRADE).define('A', Items.GOLDEN_CARROT)
                ...
                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.FURNACE_UPGRADE).define('A', Blocks.FURNACE)
                        .define('B', ModItems.BLANK_UPGRADE).define('C', ConventionalItemTags.CHESTS).pattern("A").pattern("B").pattern("C")
                        .unlockedBy(getHasName(ModItems.BLANK_UPGRADE), has(ModItems.BLANK_UPGRADE)).save(writer);

                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.SMOKER_UPGRADE).define('A', Blocks.SMOKER)
                        .define('B', ModItems.BLANK_UPGRADE).define('C', ConventionalItemTags.CHESTS).pattern("A").pattern("B").pattern("C")
                        .unlockedBy(getHasName(ModItems.BLANK_UPGRADE), has(ModItems.BLANK_UPGRADE)).save(writer);

                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.BLAST_FURNACE_UPGRADE).define('A', Blocks.BLAST_FURNACE)
                        .define('B', ModItems.BLANK_UPGRADE).define('C', ConventionalItemTags.CHESTS).pattern("A").pattern("B").pattern("C")
                        .unlockedBy(getHasName(ModItems.BLANK_UPGRADE), has(ModItems.BLANK_UPGRADE)).save(writer);

                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.PICKUP_UPGRADE).define('A', Items.HOPPER)
                        .define('B', ModItems.BLANK_UPGRADE).define('C', ConventionalItemTags.REDSTONE_DUSTS).pattern("ABA").pattern("CCC")
                        .unlockedBy(getHasName(ModItems.BLANK_UPGRADE), has(ModItems.BLANK_UPGRADE)).save(writer);

                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.JUKEBOX_UPGRADE).define('A', ConventionalItemTags.REDSTONE_DUSTS)
                        .define('B', ModItems.BLANK_UPGRADE).define('C', Items.JUKEBOX).pattern(" B ").pattern("ACA")
                        .unlockedBy(getHasName(ModItems.BLANK_UPGRADE), has(ModItems.BLANK_UPGRADE)).save(writer);

                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.REFILL_UPGRADE).define('A', Items.DROPPER)
                        .define('B', ModItems.BLANK_UPGRADE).define('C', ConventionalItemTags.REDSTONE_DUSTS).pattern("ABA").pattern("CCC")
                        .unlockedBy(getHasName(ModItems.BLANK_UPGRADE), has(ModItems.BLANK_UPGRADE)).save(writer);

                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.MAGNET_UPGRADE).define('A', ConventionalItemTags.ENDER_PEARLS)
                ...
                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.VOID_UPGRADE).define('A', Items.LAVA_BUCKET)
                        .define('B', ModItems.BLANK_UPGRADE).define('C', ConventionalItemTags.REDSTONE_DUSTS).pattern("ABA").pattern("CCC")
                        .unlockedBy(getHasName(ModItems.BLANK_UPGRADE), has(ModItems.BLANK_UPGRADE)).save(writer);

                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.LANTERN_UPGRADE).define('A', Items.LANTERN)
                        .define('B', ModItems.BLANK_UPGRADE).define('C', ConventionalItemTags.REDSTONE_DUSTS).pattern("ABA").pattern("CCC")
                        .unlockedBy(getHasName(ModItems.BLANK_UPGRADE), has(ModItems.BLANK_UPGRADE)).save(writer);

                //All Recipes
                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.BACKPACK_TANK)
                        ...
                        .unlockedBy("has_iron", has(ConventionalItemTags.IRON_INGOTS)).save(writer);

                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.HOSE_NOZZLE)
                        .define('A', ConventionalItemTags.GOLD_INGOTS).define('B', ConventionalItemTags.IRON_INGOTS)
                        .pattern(" A ").pattern("B B")
                        .unlockedBy("has_iron", has(ConventionalItemTags.IRON_INGOTS)).save(writer);

                ShapedRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.TOOLS, ModItems.HOSE)
                        .define('A', ModItems.HOSE_NOZZLE).define('B', ConventionalItemTags.GREEN_DYES)
                        .pattern("ABB").pattern("  B").pattern("  B")
                        .unlockedBy(getHasName(ModItems.HOSE_NOZZLE), has(ModItems.HOSE_NOZZLE)).save(writer);
                ...
                ShapedBackpackRecipeBuilder.shaped(registries.lookupOrThrow(Registries.ITEM), RecipeCategory.MISC, ModItems.STANDARD_TRAVELERS_BACKPACK).group("standard_travelers_backpack")
                        ...
                        .unlockedBy("has_chest", has(ConventionalItemTags.WOODEN_CHESTS)).save(writer);
