...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> writer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.BLANK_UPGRADE.get(), 4)
                .define('A', Tags.Items.LEATHER).define('B', Tags.Items.STRING)
                .pattern(" B ").pattern("BAB").pattern(" B ")
                .unlockedBy("has_leather", has(Tags.Items.LEATHER)).save(writer);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.REFILL_UPGRADE.get()).define('A', Items.DROPPER)
                .define('B', ModItems.BLANK_UPGRADE.get()).define('C', Tags.Items.DUSTS_REDSTONE).pattern("ABA").pattern("CCC")
                .unlockedBy(getHasName(ModItems.BLANK_UPGRADE.get()), has(ModItems.BLANK_UPGRADE.get())).save(writer, id("refill_upgrade"));
