...
import com.tiviacz.travelersbackpackneo.initold.ModAttachmentTypes;
import com.tiviacz.travelersbackpack.inventory.BackpackWrapper;
import com.tiviacz.travelersbackpack.item.TravelersBackpackItem;
import com.tiviacz.travelersbackpackold.component.ITravelersBackpackComponent;
...
public class AttachmentUtils {
    public static final ComponentKey<ITravelersBackpackComponent> WEARABLE = ComponentRegistry.getOrCreate(ResourceLocation.fromNamespaceAndPath(TravelersBackpack.MODID, "travelersbackpack"), ITravelersBackpackComponent.class);
