...
public class ModItems
{
    ...
    public static final RegistryObject<Item> BLANK_UPGRADE = ITEMS.register("blank_upgrade", () -> new UpgradeItem(new Item.Properties().tab(Reference.TAB_TRAVELERS_BACKPACK), UpgradeItem.Upgrade.BLANK_UPGRADE));
    public static final RegistryObject<Item> IRON_TIER_UPGRADE = ITEMS.register("iron_tier_upgrade", () -> new UpgradeItem(new Item.Properties().tab(Reference.TAB_TRAVELERS_BACKPACK).stacksTo(16), UpgradeItem.Upgrade.IRON_TIER_UPGRADE));
    public static final RegistryObject<Item> GOLD_TIER_UPGRADE = ITEMS.register("gold_tier_upgrade", () -> new UpgradeItem(new Item.Properties().tab(Reference.TAB_TRAVELERS_BACKPACK).stacksTo(16), UpgradeItem.Upgrade.GOLD_TIER_UPGRADE));
    public static final RegistryObject<Item> DIAMOND_TIER_UPGRADE = ITEMS.register("diamond_tier_upgrade", () -> new UpgradeItem(new Item.Properties().tab(Reference.TAB_TRAVELERS_BACKPACK).stacksTo(16), UpgradeItem.Upgrade.DIAMOND_TIER_UPGRADE));
    public static final RegistryObject<Item> NETHERITE_TIER_UPGRADE = ITEMS.register("netherite_tier_upgrade", () -> new UpgradeItem(new Item.Properties().tab(Reference.TAB_TRAVELERS_BACKPACK).stacksTo(16), UpgradeItem.Upgrade.NETHERITE_TIER_UPGRADE));
    public static final RegistryObject<Item> CRAFTING_UPGRADE = ITEMS.register("crafting_upgrade", () -> new UpgradeItem(new Item.Properties().tab(Reference.TAB_TRAVELERS_BACKPACK).stacksTo(16), UpgradeItem.Upgrade.CRAFTING_UPGRADE));
