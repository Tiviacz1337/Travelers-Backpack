...
public class ModItems
{
    ...
    public static void init()
    {
        ...
        GOLD_TIER_UPGRADE = Registry.register(Registry.ITEM, new Identifier(TravelersBackpack.MODID, "gold_tier_upgrade"), new TierUpgradeItem(new FabricItemSettings().maxCount(16), Tiers.GOLD));
        DIAMOND_TIER_UPGRADE = Registry.register(Registry.ITEM, new Identifier(TravelersBackpack.MODID, "diamond_tier_upgrade"), new TierUpgradeItem(new FabricItemSettings().maxCount(16), Tiers.DIAMOND));
        NETHERITE_TIER_UPGRADE = Registry.register(Registry.ITEM, new Identifier(TravelersBackpack.MODID, "netherite_tier_upgrade"), new TierUpgradeItem(new FabricItemSettings().maxCount(16), Tiers.NETHERITE));
    }
