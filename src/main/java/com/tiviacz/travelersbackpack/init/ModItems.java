...
public class ModItems
{
    ...
    public static void init()
    {
        ...
        GOLD_TIER_UPGRADE = Registry.register(Registries.ITEM, new Identifier(TravelersBackpack.MODID, "gold_tier_upgrade"), new TierUpgradeItem(new FabricItemSettings().maxCount(16), Tiers.IRON));
        DIAMOND_TIER_UPGRADE = Registry.register(Registries.ITEM, new Identifier(TravelersBackpack.MODID, "diamond_tier_upgrade"), new TierUpgradeItem(new FabricItemSettings().maxCount(16), Tiers.GOLD));
        NETHERITE_TIER_UPGRADE = Registry.register(Registries.ITEM, new Identifier(TravelersBackpack.MODID, "netherite_tier_upgrade"), new TierUpgradeItem(new FabricItemSettings().maxCount(16), Tiers.DIAMOND));
    }
