...
public class ModCrafting
{
    ...
    public static final SpecialRecipeSerializer<BackpackDyeRecipe> BACKPACK_DYE = InjectionUtils.Null();
    ...
    public static void register(final RegistryEvent.Register<IRecipeSerializer<?>> event)
    {
        ...
        event.getRegistry().registerAll(new SpecialRecipeSerializer<>(BackpackDyeRecipe::new).setRegistryName(new ResourceLocation(TravelersBackpack.MODID, "backpack_dye")));
    }
}