...
public class ModBlocks {
    ...
    //Standard
    public static final DeferredBlock<TravelersBackpackBlock> STANDARD_TRAVELERS_BACKPACK = BLOCKS.registerBlock("standard", TravelersBackpackBlock::new, Block.Properties.of().mapColor(MapColor.COLOR_BROWN).sound(SoundType.WOOL));  //() -> new TravelersBackpackBlock(Block.Properties.of().mapColor(MapColor.COLOR_BROWN).sound(SoundType.WOOL)));
