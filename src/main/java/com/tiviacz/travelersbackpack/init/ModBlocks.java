...
public class ModBlocks
{
    ...
    public static final RegistryObject<Block> REDSTONE_TRAVELERS_BACKPACK = BLOCKS.register("redstone", () -> new TravelersBackpackBlock(Block.Properties.of(new Material.Builder(MaterialColor.FIRE).build()).sound(SoundType.METAL).isRedstoneConductor((state, blockReader, pos) -> false)));
    ...
    public static final RegistryObject<Block> END_TRAVELERS_BACKPACK = BLOCKS.register("end", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.COLOR_GREEN).build()).sound(SoundType.GLASS)));
    public static final RegistryObject<Block> NETHER_TRAVELERS_BACKPACK = BLOCKS.register("nether", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.NETHER).build()).sound(SoundType.NETHER_BRICKS)));
    public static final RegistryObject<Block> SANDSTONE_TRAVELERS_BACKPACK = BLOCKS.register("sandstone", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.SAND).build()).sound(SoundType.STONE)));
    public static final RegistryObject<Block> SNOW_TRAVELERS_BACKPACK = BLOCKS.register("snow", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.SNOW).build()).sound(SoundType.SNOW)));
    public static final RegistryObject<Block> SPONGE_TRAVELERS_BACKPACK = BLOCKS.register("sponge", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.COLOR_YELLOW).build()).sound(SoundType.GRASS)));

    //Food
    public static final RegistryObject<Block> CAKE_TRAVELERS_BACKPACK = BLOCKS.register("cake", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.NONE).build()).sound(SoundType.WOOL)));
    //Plants
    public static final RegistryObject<Block> CACTUS_TRAVELERS_BACKPACK = BLOCKS.register("cactus", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.PLANT).build()).sound(SoundType.WOOL)));
    ...
    //Mobs
    public static final RegistryObject<Block> CREEPER_TRAVELERS_BACKPACK = BLOCKS.register("creeper", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.COLOR_GREEN).build()).sound(SoundType.WOOL)));
    public static final RegistryObject<Block> DRAGON_TRAVELERS_BACKPACK = BLOCKS.register("dragon", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.TERRACOTTA_BLACK).build()).sound(SoundType.METAL)));
    public static final RegistryObject<Block> ENDERMAN_TRAVELERS_BACKPACK = BLOCKS.register("enderman", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.COLOR_BLACK).build()).sound(SoundType.WOOL)));
    ...
    public static final RegistryObject<Block> GHAST_TRAVELERS_BACKPACK = BLOCKS.register("ghast", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.COLOR_LIGHT_GRAY).build()).sound(SoundType.WOOL)));
    public static final RegistryObject<Block> MAGMA_CUBE_TRAVELERS_BACKPACK = BLOCKS.register("magma_cube", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.NETHER).build()).sound(SoundType.SLIME_BLOCK)));
    public static final RegistryObject<Block> SKELETON_TRAVELERS_BACKPACK = BLOCKS.register("skeleton", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.WOOL).build()).sound(SoundType.BONE_BLOCK)));
    public static final RegistryObject<Block> SPIDER_TRAVELERS_BACKPACK = BLOCKS.register("spider", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.COLOR_BLACK).build()).sound(SoundType.WOOL)));
    public static final RegistryObject<Block> WITHER_TRAVELERS_BACKPACK = BLOCKS.register("wither", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.COLOR_BLACK).build()).sound(SoundType.BONE_BLOCK)));
    ...
    public static final RegistryObject<Block> SHEEP_TRAVELERS_BACKPACK = BLOCKS.register("sheep", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.TERRACOTTA_WHITE).build()).sound(SoundType.WOOL)));
    ...
    public static final RegistryObject<Block> SQUID_TRAVELERS_BACKPACK = BLOCKS.register("squid", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.TERRACOTTA_BLUE).build()).sound(SoundType.SLIME_BLOCK)));
    ...
    public static final RegistryObject<Block> IRON_GOLEM_TRAVELERS_BACKPACK = BLOCKS.register("iron_golem", () -> new TravelersBackpackBlock(AbstractBlock.Properties.of(new Material.Builder(MaterialColor.METAL).build()).sound(SoundType.METAL)));
