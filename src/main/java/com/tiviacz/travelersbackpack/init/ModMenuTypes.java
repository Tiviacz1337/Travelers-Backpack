...
public class ModMenuTypes
{
    ...
    public static final RegistryObject<MenuType<TravelersBackpackBlockEntityMenu>> TRAVELERS_BACKPACK_BLOCK_ENTITY = MENU_TYPES.register("travelers_backpack_block_entity", () -> IForgeContainerType.create(TravelersBackpackBlockEntityMenu::new));
