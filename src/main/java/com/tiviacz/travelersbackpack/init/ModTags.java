...
public class ModTags
{
    ...
    public static final TagKey<Item> SLEEPING_BAGS = TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation(TravelersBackpack.MODID, "sleeping_bags"));
    public static final TagKey<Item> BACKPACK_UPGRADES = TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation(TravelersBackpack.MODID, "backpack_upgrades"));
}