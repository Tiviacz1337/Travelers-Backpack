...
public class ModTags
{
    ...
    public static final TagKey<Item> SLEEPING_BAGS = TagKey.of(Registry.ITEM_KEY, new Identifier(TravelersBackpack.MODID, "sleeping_bags"));
    public static final TagKey<Item> BACKPACK_UPGRADES = TagKey.of(Registry.ITEM_KEY, new Identifier(TravelersBackpack.MODID, "backpack_upgrades"));
}