...
public class ServerboundFillTankPacket implements IPacket<ServerboundFillTankPacket> {
    ...
    public void encode(final ServerboundFillTankPacket message, final FriendlyByteBuf buffer) {
        buffer.writeBoolean(message.leftTank);
    }

    public ResourceLocation getPacketId() {
        return ModNetwork.FILL_TANK_ID;
    }

    public static void handle(MinecraftServer server, ServerPlayer player, ServerGamePacketListenerImpl handler, FriendlyByteBuf buf, PacketSender responseSender) {
        ServerboundFillTankPacket message = decode(buf);
        server.execute(() -> {
