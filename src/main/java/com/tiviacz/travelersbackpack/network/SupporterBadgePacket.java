...
public class SupporterBadgePacket {
    public static class Serverbound {
        ...
        public static void handle(final Serverbound message, final CustomPayloadEvent.Context ctx) {
            ctx.enqueueWork(() -> {
    ...
    public static class Clientbound {
        ...
        public static void handle(final Clientbound message, final CustomPayloadEvent.Context ctx) {
            ctx.enqueueWork(() -> {
