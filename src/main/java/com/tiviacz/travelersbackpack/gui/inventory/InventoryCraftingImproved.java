...
public class InventoryCraftingImproved extends InventoryCrafting
{
    ...
    private final IInventoryTravelersBackpack inv;

    public InventoryCraftingImproved(IInventoryTravelersBackpack inventory, Container eventHandlerIn, int width, int height)
    {
