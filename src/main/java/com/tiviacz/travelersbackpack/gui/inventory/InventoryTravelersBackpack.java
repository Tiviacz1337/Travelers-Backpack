...
public class InventoryTravelersBackpack implements IInventoryTravelersBackpack
{
	...
	private NonNullList<ItemStack> inventory = NonNullList.withSize(Reference.INVENTORY_SIZE, ItemStack.EMPTY);
	private NonNullList<ItemStack> craftingGrid = NonNullList.withSize(Reference.CRAFTING_GRID_SIZE, ItemStack.EMPTY);
	...
	public void sendPacket()
	{
		...
		{
			TravelersBackpack.NETWORK.sendToAllTracking(new SyncBackpackCapabilityMP(stack.writeToNBT(new NBTTagCompound()), player.getEntityId()), player);
		}
	}
