package com.tiviacz.travelersbackpackold.client.model;

import com.tiviacz.travelersbackpackold.client.renderer.FluidPart;
import com.tiviacz.travelersbackpackold.client.renderer.StackPart;
...
public class BackpackFeatureModel<T extends LivingEntity> extends BipedEntityModel<T> {
    ...
    public void render(MatrixStack matrices, VertexConsumer vertices, int light, int overlay, int rgb) {
        ...
        if (this.livingEntity != null) {
            //Item item = this.livingEntity instanceof PlayerEntity ? ComponentUtils.getWearingBackpack((PlayerEntity)this.livingEntity).getItem() : this.livingEntity.getEquippedStack(EquipmentSlot.BODY).getItem();
