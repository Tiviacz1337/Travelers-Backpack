...
import com.tiviacz.travelersbackpackold.inventory.CraftingInventoryImproved;
...
import com.tiviacz.travelersbackpackold.inventory.screen.slot.FluidSlot;
...
import com.tiviacz.travelersbackpackold.util.ItemStackUtils;
...
public class TravelersBackpackBaseScreenHandler extends ScreenHandler
{
    ...
    protected static void slotChangedCraftingGrid(ScreenHandler handler, World world, PlayerEntity player, CraftingRecipeInput craftMatrix, CraftingResultInventory craftResult)
    {
        ...
        if(optional.isPresent())
        {
            ...
            if(craftResult.shouldCraftRecipe(world, serverPlayerEntity, recipeEntry) && (itemStack2 = craftingRecipe.craft(craftMatrix, world.getRegistryManager())).isItemEnabled(world.getEnabledFeatures()))
            {
                itemStack = itemStack2;
            }
        }
